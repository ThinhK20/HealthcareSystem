...
export default function ContactUs() {
  ...
  const handleClick = async (e) => {
    ...
    if (api_create.status === "Success") {
      ...
      toast.error("Error while sent you message.Please send again !", {
         position: "top-right",
         autoClose: 2000,
         hideProgressBar: false,
         closeOnClick: true,
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white my-6 font-sans text-gray-400 rounded-lg">
      <div className="text-center px-6">
        {/* <h1 className="font-bold font-sans text-gray-700 text-xl">
               Contact Us
            </h1>
            <h2 className="text-[#1A1446] text-xl">
      ...
      <div className="grid font-sans lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8 pl-6">
        <div className="bg-gradient-to-r from-[#FFD000] to-[#ffb347] rounded-lg p-6 max-lg:text-center">
          ...
          <p className="text-sm text-[#1A1446] mt-3">
            Have some problems or need help ?
          </p>
          <ul className="mt-16 space-y-10">
            <li className="flex items-center max-lg:justify-center">
              ...
              <a
                ...
                className="text-[#1A1446] text-sm ml-3"
              >
