        ...
        <div className="mb-4 flex flex-col justify-between gap-8 md:flex-row md:items-center">
          <div>
            ...
            <Typography color="gray" className="mt-1 font-normal">
              There are a total of <strong>{accounts?.length}</strong> customers
              in the system, and here are the details:
            </Typography>
          </div>
        </div>
      </CardHeader>
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="text-center border-b border-blue-gray-50 ">
                    <Link to={`/staffs/refund-requests/${tableRow.status}`}>
                    ...
                    <Link to={`/staffs/payment?acc=${tableRow.accountId}`}>
                      <Tooltip title="View details">
                        <IconButton variant="text">
                          <FontAwesomeIcon
                            className="h-4 w-4"
