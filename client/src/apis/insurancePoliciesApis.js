...
export const createPolicy = async (data) => {
   try {
      ...
      console.error(
         "Error occurred while trying to create an insurance policy",
         error
      );
   }
};
export const detailPolicy = async (packageId, policyId) => {
   try {
      const response = await instance.get(
         `policy-packages/detail-package?packageId=${packageId}&policyId=${policyId}`
      );
      return response.data;
   } catch (error) {
      console.error(
...
export const updatePolicy = async (data) => {
   try {
      ...
      console.error(
         "Error occurred while trying to update an insurance policy",
         error
      );
   }
};
