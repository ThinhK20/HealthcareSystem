...
namespace HealthcareSystem.Backend.Migrations
{
    ...
    [Migration("20231208125638_ChangeUserIdToAccountId_Insurance")]
    partial class ChangeUserIdToAccountId_Insurance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HealthcareSystem.Backend.Models.Entity.Account", b =>
                {
                    ...
                    b.HasIndex("InsuranceAccountId")
                        .IsUnique()
                        .HasFilter("[InsuranceAccountId] IS NOT NULL");
            ...
            modelBuilder.Entity("HealthcareSystem.Backend.Models.Entity.Account", b =>
                {
                    b.HasOne("Insurance", "Insurance")
                        .WithOne("Account")
                        .HasForeignKey("HealthcareSystem.Backend.Models.Entity.Account", "InsuranceAccountId")
                        .HasPrincipalKey("Insurance", "AccountId");
